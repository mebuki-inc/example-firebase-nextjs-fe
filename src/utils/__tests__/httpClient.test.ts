...
describe('httpClient', () => {
  ...
  describe('fetch', () => {
    ...
    test.each`
      ...
      ${'http://localhost'} | ${'/api/v1/users'} | ${requestHeader} | ${params} | ${200} | ${stubResponseHeaders} | ${stubResponseBody} | ${success}             | ${'正常にレスポンスが返却される場合、{ status, body, headers, error: true } が正常に返却される'}
  ...
  describe('mutate', () => {
    ...
    test.each`
      ...
      ${'http://localhost'} | ${'post'}   | ${'/api/v1/users'}   | ${requestHeader} | ${body} | ${200} | ${stubResponseHeaders} | ${stubMutateResponseBody} | ${success}             | ${'POSTに成功した場合、{ status, body: null, headers, error: true } が正常に返却される'}
